<template>
     <div v-if="viewMode === 'list'" @click="toggleViewMode" class="flex flex-col items-center p-8 w-full rounded-2xl cursor-pointer bg-slate-50">
            ...
            <img :src="data.imgUrl" alt="Imágen del pago de mantenimiento" class="rounded-2xl">
            ...
            <button
              ...
              class="px-4 py-2 mt-4 text-white bg-red-600 rounded-lg transition-colors hover:bg-red-700"
            >
            Eliminar
              <v-icon name="fa-trash-alt" class="text-white" />
            </button>
          </div>
          <div v-else @click="toggleViewMode" class="flex flex-col items-center p-4 mx-4 w-64 rounded-2xl transition-transform duration-300 cursor-pointer hover:scale-105 bg-slate-50">
            ...
            <img :src="data.imgUrl" alt="Imágen del pago de mantenimiento" class="w-48 rounded-2xl">
