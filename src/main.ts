...
import { FaFlag, RiZhihuFill, RiBuildingFill, LaFileInvoiceDollarSolid,MdShorttextRound,BiTextParagraph, RiImageAddLine,IoCloseCircle,FaFileInvoice, FaTrashAlt,RiChatPrivateLine,IoNotificationsOutline,MdNotificationsactive, GiHouseKeys , FaHouseUser,GiMoneyStack, GiTakeMyMoney,BiCardChecklist, RiCalendar2Line, RiHome2Line, RiInformationLine, BiCurrencyExchange, BiTrashFill, FaCommentDots,CoHouse} from "oh-vue-icons/icons";
addIcons(FaFlag, RiZhihuFill, RiBuildingFill, LaFileInvoiceDollarSolid,MdShorttextRound, BiTextParagraph, RiImageAddLine,IoCloseCircle,FaFileInvoice, FaTrashAlt,RiChatPrivateLine,IoNotificationsOutline,MdNotificationsactive, GiHouseKeys, FaHouseUser,GiMoneyStack, GiTakeMyMoney, BiCardChecklist, RiCalendar2Line, RiHome2Line, RiInformationLine, BiCurrencyExchange, BiTrashFill,FaCommentDots,CoHouse);
