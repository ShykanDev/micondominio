<template>
   <MainLayout>
    <template #main>
      ...
      <img class="fixed top-0 bottom-0 left-0 right-0 w-full -z-20" src="https://images.pexels.com/photos/7195310/pexels-photo-7195310.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
