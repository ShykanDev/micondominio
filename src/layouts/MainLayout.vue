  ...
  <header class="sticky top-0 z-50">
    <div
      ...
      <nav class="hidden space-x-6 md:flex">
        <RouterLink :to="{ name: 'home' }" href="#"
          ...
          Inicio</RouterLink>
        <RouterLink :to="{ name: 'comments' }" href="#"
          class="p-1 font-medium transition-colors duration-100 ease-out rounded-md text-sky-800 hover:bg-sky-900 hover:text-white ">
          Comentarios</RouterLink>
        <RouterLink :to="{ name: 'contact' }" href="#"
          class="p-1 font-medium transition-colors duration-100 ease-out rounded-md text-sky-800 hover:bg-sky-900 hover:text-white ">
          Contacto</RouterLink>
        <RouterLink :to="{ name: 'about' }" href="#"
          class="p-1 font-medium transition-colors duration-100 ease-out rounded-md text-sky-800 hover:bg-sky-900 hover:text-white ">
          Mi Condominio</RouterLink>
        <RouterLink v-if="!sysVals().getIsUserAuth" :to="{ name: 'login' }" href="#"
        ...
        <RouterLink v-if="!sysVals().getIsUserAuth" :to="{ name: 'register' }" href="#"
          class="p-1 font-medium text-white transition-colors duration-100 ease-out rounded-md bg-sky-900 hover:text-white">
          Registrarse</RouterLink>
        <RouterLink v-if="sysVals().getIsAdmin" :to="{ name: 'dashboard' }" href="#"
    ...
    <div id="mobile-menu" class="hidden md:hidden">
      <nav class="px-4 py-4 space-y-2">
        <RouterLink :to="{ name: 'home' }" href="#"
          class="block p-1 font-medium text-white transition-colors duration-100 ease-out rounded-md bg-sky-700 hover:text-white ">
          Inicio</RouterLink>
        <RouterLink :to="{ name: 'home' }" href="#"
          class="block p-1 font-medium text-white transition-colors duration-100 ease-out rounded-md bg-sky-700 hover:text-white ">
          Sobre</RouterLink>
